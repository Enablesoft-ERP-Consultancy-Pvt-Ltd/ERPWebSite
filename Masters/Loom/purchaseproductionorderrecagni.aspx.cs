...
//        else {
            ...
            string Str = "select issueorderid,issueorderid as issueorder from PROCESS_ISSUE_MASTER_1 Where empid=" + ddempname.SelectedValue + "";
            //if (Session["varCompanyno"].ToString() != "6")
            //{
            //    Str = Str + "  AND DM.Departmentname='PURCHASE'";
            //}
