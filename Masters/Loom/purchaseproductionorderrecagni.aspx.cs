                ...
                switch (Session["varMasterCompanyIDForERP"].ToString())
                {
                    ...
                    case "44":
                     DropDownList ddgodwn = (DropDownList)e.Row.FindControl("ddgodwn");
                         string str1 = "";
            str1 = "Select Distinct GM.GodownID,GM.GodownName From GodownMaster GM JOIN Godown_Authentication GA ON GM.GoDownID=GA.GodownID and GA.UserID=" + Session["varUserId"] + " and GA.MasterCompanyId=" + Session["varMasterCompanyIDForERP"] + @" Order By GodownName";
