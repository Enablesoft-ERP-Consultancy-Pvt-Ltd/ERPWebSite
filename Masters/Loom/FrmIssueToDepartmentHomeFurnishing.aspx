<%@ Page Language="C#" MasterPageFile="~/ERPmaster.master" AutoEventWireup="true"
    CodeFile="FrmIssueToDepartmentHomeFurnishing.aspx.cs" Inherits="Masters_Loom_FrmIssueToDepartmentHomeFurnishing" %>
    ...
    <script type="text/javascript">
        function NewForm() {
            if (document.getElementById('CPH_Form_chkEdit') == null) {
                window.location.href = "FrmIssueToDepartmentHomeFurnishing.aspx";
            }
                ...
                window.location.href = "FrmIssueToDepartmentHomeFurnishing.aspx?ForEdit=1";
            } else {
                window.location.href = "FrmIssueToDepartmentHomeFurnishing.aspx";
            }
        }
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField Visible="false">
                                                <ItemTemplate>
                                                    ...
                                                    <asp:Label ID="lblOrderDetailDetail_FinishedID" Text='<%#Bind("OrderDetailDetail_FinishedID") %>' runat="server" />
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                        </Columns>
                                    </asp:GridView>
