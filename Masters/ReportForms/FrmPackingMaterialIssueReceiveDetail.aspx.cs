...
public partial class Masters_ReportForms_FrmPackingMaterialIssueReceiveDetail : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            Where CA.CompanyId=CI.CompanyId And CA.UserId=" + Session["varuserId"] + " And CI.MasterCompanyId=" + Session["varMasterCompanyIDForERP"] + @" Order By Companyname 
            ...
            Where a.MasterCompanyId = " + Session["varMasterCompanyIDForERP"] + @" And a.CompanyID = " + Session["CurrentWorkingCompanyID"].ToString() + @"
