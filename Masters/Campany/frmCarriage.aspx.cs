...
public partial class Masters_Campany_frmCarriage : CustomPage
{
    ...
    private DataSet Fill_Grid_Data()
    {
        ...
        try
        {
            string strsql = "select * from Carriage Where MasterCompanyId=" + Session["varMasterCompanyIDForERP"] + " order by carriageid";
            con.Open();
    ...
    private void Validated()
    {
        ...
        try
        {
            ...
            {
                strsql = "select CarriageName from Carriage where CarriageId!='" + ViewState["CarriageId"].ToString() + "' and CarriageName='" + txtCarriage.Text + "' And MasterCompanyId=" + Session["varMasterCompanyIDForERP"];
            }
            else
            {
