...
public partial class Masters_Carpet_AddRecipeName : System.Web.UI.Page
{
    ...
    private DataSet Fill_Grid_Data()
    {
        ...
        try
        {
            string strsql = @"Select ID, Name From RecipeMaster(Nolock) Where ProcessID = " + Request.QueryString["ProcessID"] + " And MasterCompanyId = " + Session["varMasterCompanyIDForERP"] + " Order By Name";
