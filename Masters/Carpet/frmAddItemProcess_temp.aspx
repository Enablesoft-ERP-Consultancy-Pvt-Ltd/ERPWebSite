<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmAddItemProcess_temp.aspx.cs"
    Inherits="Masters_Process_frmAddItemProcess_temp" %>
                    ...
                    <tr>
                        <td>
                            ...
                            <asp:RadioButtonList ID="rdbtnLst" runat="server" RepeatDirection="Horizontal" DataValueField="ItemId"
                                DataTextField="ItemName"></asp:RadioButtonList>
