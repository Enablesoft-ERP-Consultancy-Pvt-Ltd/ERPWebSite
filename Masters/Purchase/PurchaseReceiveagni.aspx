<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PurchaseReceiveagni.aspx.cs"
    Title="Purchase Receive" MasterPageFile="~/ERPmaster.master" Inherits="Masters_Purchase_PurchaseReceiveagni" %>
...
<asp:Content ID="page" ContentPlaceHolderID="CPH_Form" runat="server">
    ...
    <script type="text/javascript">
        ...
        function NewForm() {
            window.location.href = "PurchaseReceiveagni.aspx";
        }
        function validate() {
                                        ...
                                        <asp:TemplateField ShowHeader="False">
                                            <ItemTemplate>
                                                <asp:LinkButton ID="LinkButton1" runat="server" CausesValidation="False" CommandName="Delete"
                                                    Width="50px" Text="DEL" OnClientClick="return doconfirm('Do you want to Delete data?')"
