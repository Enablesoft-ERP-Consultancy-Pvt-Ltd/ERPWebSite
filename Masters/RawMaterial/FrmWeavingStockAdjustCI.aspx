<%@ Page Title="Weaving Stock Adjust" Language="C#" AutoEventWireup="true" CodeFile="FrmWeavingStockAdjustCI.aspx.cs"
    MasterPageFile="~/ERPmaster.master" EnableEventValidation="false" Inherits="Masters_RawMaterial_FrmWeavingStockAdjustCI" %>
...
<asp:Content ID="page" ContentPlaceHolderID="CPH_Form" runat="server">
    ...
    <script type="text/javascript">
        function NewForm() {
            window.location.href = "FrmWeavingStockAdjustCI.aspx";
        }
        function CloseForm() {
                           ...
                           <%-- <td>
                            ...
                            <td id="Td4">
                                ...
                                <asp:CheckBox ID="ChKForEdit" runat="server" Text=" Check For Edit" CssClass="checkboxbold"
                                    AutoPostBack="true" OnCheckedChanged="ChKForEdit_CheckedChanged" Visible="false" />
                                <br />
                             ...
                             <td id="Td8">
                                <asp:Label ID="Label38" Text=" Series." runat="server" CssClass="labelbold" />
                                <br />
                                <asp:DropDownList ID="DDCarpetQuality" runat="server" Width="130px" CssClass="dropdown"
                                    OnSelectedIndexChanged="DDCarpetQuality_SelectedIndexChanged" AutoPostBack="True">
                                </asp:DropDownList>
                            </td>
                ...
                <fieldset>
                    ...
                    <table>
                        <tr>
                            ...
                            <td>
                                <asp:Label ID="Label17" Text="Adjust Quantity" runat="server" CssClass="labelbold" />
                                <br />
            ...
            <table width="100%">
                <tr>
                    <td style="width: 50%">
                        ...
                        <asp:GridView ID="GVPendingMaterialDetail" runat="server" AutoGenerateColumns="False" OnRowDataBound="GVPendingMaterialDetail_RowDataBound"
                                >
                                <HeaderStyle CssClass="gvheaders" />
                                <AlternatingRowStyle CssClass="gvalts" />
                                <Columns>
                                    <asp:TemplateField HeaderText="Issue ChallanNo">
                                        <ItemTemplate>
                                            <asp:Label ID="lblIssueChallanNo" Text='<%#Bind("ChallanNo") %>' runat="server" />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Consmp Qty" Visible="false">
                                        <ItemTemplate>
                                            <asp:Label ID="lblConsmpQty" Text='<%#Bind("Qty") %>' runat="server" />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="IssQty" Visible="false">
                                        <ItemTemplate>
                    ...
                    <td style="width: 50%" valign="top">
                        <%--<div style="max-height: 300px; overflow: auto;">
                            <asp:GridView ID="gvdetail" runat="server" AutoGenerateColumns="False" OnRowDataBound="gvdetail_RowDataBound"
                                ...
                                <AlternatingRowStyle CssClass="gvalts" />
                                <Columns>
                                <asp:TemplateField HeaderText="FolioChallanNo">
                                        <ItemTemplate>
