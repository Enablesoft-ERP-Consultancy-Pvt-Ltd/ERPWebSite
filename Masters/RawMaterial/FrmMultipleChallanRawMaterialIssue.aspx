<%@ Page Title="Multiple Challan Raw Issue" Language="C#" AutoEventWireup="true" CodeFile="FrmMultipleChallanRawMaterialIssue.aspx.cs"
    MasterPageFile="~/ERPmaster.master" EnableEventValidation="false" Inherits="Masters_RawMaterial_FrmMultipleChallanRawMaterialIssue" %>
...
<asp:Content ID="page" ContentPlaceHolderID="CPH_Form" runat="server">
    ...
    <script type="text/javascript">
        function NewForm() {
            window.location.href = "FrmMultipleChallanRawMaterialIssue.aspx";
        }
        function CloseForm() {
